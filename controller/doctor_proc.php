...
if($mode)
{
	...
	include dirname(__FILE__).'/../core/dao/DoctorDao.class.php';
	...
	switch($mode)
	{
		case 'insert' :
            ...
            foreach($_POST as $key => $value) {
                $params['doctors'][$key] = $purifier->purify($value);
            }
        ...
        case 'delete_file':
            $params['doctors'][$_POST['fileName'].'_path'] = NULL;
            $params['doctors'][$_POST['fileName'].'_name'] = NULL;
            unset($_POST['mode']);
            $where = " id = ".$_POST['id'];
            unset($_POST['id']);
            $table = "doctors";
        ...
        case 'get_doctors':
            $result =  $dao->board->getDoctors('doctors', $_POST['department_id']);
        break;

...
if($mode)
{
	...
	include dirname(__FILE__).'/../core/dao/FastConsultCommentDao.class.php';
	include dirname(__FILE__).'/../core/dao/BoardDao.class.php';
	include dirname(__FILE__).'/../function.php';

	$dao = new FastConsultCommentDao();
	...
	switch($mode)
	{
		case 'insert' :
            ...
            foreach($_POST as $key => $value) {
                $params['fast_consult_comments'][$key] = $purifier->purify($value);
            }

...
<section class="section">
    <div class="container-fluid">
        <?php echo sectionTitle("비급여 행위료 등록", "비급여 행위료 관리", "비급여 행위료 등록"); ?>
        <div class="col-lg-12">
                        ...
                        <div class="col-6">
                            <div class="input-style-1">
                                ...
                                <input type="text" name="treatment_include" title="치료재료대 포함여부"
                                       placeholder="치료재료대 포함여부를 입력해주세요">
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="input-style-1">
        ...
        if (checkValidate === true) {
            jQuery.ajax({
                ...
                success: function(response) {
                    if (response.result) {
                        alert(response.msg);
                        location.href = '/admin/unpaid-act';
                    } else {
                        alert(response.msg);
                        return false;
                    }

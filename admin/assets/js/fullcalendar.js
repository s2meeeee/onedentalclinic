...
var FullCalendar = (function (exports) {
    ...
    */
    ...
    // Computes a default healthColumn header formatting string if `colFormat` is not explicitly defined
        ...
        function recordVisible(placement) {
            ...
            if (!segIsVisible[instanceId]) {
                ...
                for (var col = seg.firstCol; col <= seg.lastCol; col += 1) {
                    ...
                    var newPosition = 0;
                    // insert while keeping top sorted in each healthColumn
    ...
    */
    ...
    // Given an array of segments that are all in the same healthColumn, sets the backwardCoord and forwardCoord on each.
        ...
        TimeCol.prototype.renderPositionedFgSegs = function (segs, segIsInvisible, isDragging, isResizing, isDateSelecting) {
            ...
            return segs.map(function (seg) {
                ...
                var positionCss = isMirror
                    // will span entire healthColumn width

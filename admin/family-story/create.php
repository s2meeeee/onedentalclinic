...
<section class="section">
    <div class="container-fluid">
        <?php echo sectionTitle("원치과 가족이야기 등록", "원치과 가족이야기 관리", "원치과 가족이야기 등록"); ?>
        <div class="col-lg-12">
            <div class="card-style settings-card-2 mb-30">
                <form id="_form" method="post" enctype="multipart/form-data">
                    <input type="hidden" name="mode" value="insert" readonly>
                    <input type="hidden" name="gubun" value="familyStory" readonly>
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 d-flex justify-content-between">
                            <a class="btn info-btn btn-hover" href="/admin/family-story">목록</a>
        ...
        if (checkValidate === true) {
            jQuery.ajax({
                ...
                success: function(response) {
                    if (response.result) {
                        alert(response.msg);
                        location.href = '/admin/family-story';
                    } else {
                        alert(response.msg);
                        return false;
                    }

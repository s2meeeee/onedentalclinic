...
$excel_title = "원치과 가족이야기 ".date("Y-m-d h:i:s");
...
<section class="section">
    <div class="container-fluid">
        <?php echo sectionTitle("원치과 가족이야기 목록", "원치과 가족이야기 관리", "원치과 가족이야기 목록"); ?>
...
<!--                                </form>-->
                                ...
                                if($data['total_cnt'] > 0):
                                    ...
                                    foreach($data['values'] as $value):
                                        ...
                                        <tr>
                                            ...
                                            <td class="min-width">
                                                <p>
                                                    <a href="/admin/family-story/edit.php?id=<?php echo $value['id'] ?>" title="<?php echo $value['title'] ?>">
                                                        <?php
                ...
                <div class="col-lg-12">
                    <div class="d-flex justify-content-between">
                        ...
                        <div>
                            <a href="/admin/family-story/create.php" class="btn primary-btn btn-hover">등록</a>
                        </div>
                    </div>
                </div>
            </div>

<?php
    ...
    $dao = new ConsultDao();
    $fastConsultCommentDao = new ConsultCommentDao();
    ...
    $fastConsultCommentsWhere = " WHERE consult_id = ".$data['id'];
    $fastConsultCommentData = $fastConsultCommentDao->getList('consult_comment', $fastConsultCommentsWhere);
?>
                ...
                <form id="_form" method="post" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 d-flex justify-content-between">
                            <a class="btn info-btn btn-hover" href="/admin/fast">목록</a>
                        </div>
                    </div>

<?php
    ...
    $data = $dao->getDetail("unpaid_acts", $where);
...
<section class="section">
    <div class="container-fluid">
        <?php echo sectionTitle("비급여 행위료 수정", "비급여 행위료 관리", "비급여 행위료 수정"); ?>
        <div class="col-lg-12">
                    ...
                    <div class="row">
                        <div class="col-6">
                            <div class="input-style-1">
                                <label class="text-danger">중분류</label>
                                <input type="text" name="middle_classification" title="중분류" class="required"
                                       placeholder="중분류를 입력해주세요" value="<?php echo $data["middle_classification"] ?>">
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="input-style-1">
                                <label>소분류</label>
                                <input type="text" name="small_classification" title="소분류"
                                       placeholder="소분류를 입력해주세요" value="<?php echo $data["small_classification"] ?>">
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="input-style-1">
                        ...
                        <div class="col-6">
                            <div class="input-style-1">
                                <label>치료재료대 포함여부</label>
                                <input type="text" name="treatment_include" title="치료재료대 포함여부"
                                       placeholder="치료재료대 포함여부를 입력해주세요" value="<?php echo $data["treatment_include"] ?>">
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="input-style-1">
                                <label>약제비 포함여부</label>
                                <input type="text" name="drug_include" title="약제비 포함여부"
                                       placeholder="약제비 포함여부를 입력해주세요" value="<?php echo $data["drug_include"] ?>">
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="input-style-1">
                        ...
                        <div class="col-12 d-flex justify-content-between">
                            <a class="btn info-btn btn-hover" href="/admin/unpaid-act">목록</a>
...
<script>
    jQuery("#_form").submit(function(event){
        ...
        if (checkValidate === true) {
            jQuery.ajax({
                type:"POST",
                url:"../../controller/unpaid_act_proc.php",
                dataType:"json",

<?php
    ...
    $where = " AND gubun in ('worker', 'a_worker')";
    ...
    $gubuns = ['customer' => '고객', 'a_worker' => '관리직원', 'worker'=> '일반직원'];

?>
<section class="section">
    <div class="container-fluid">
        <?php echo sectionTitle("직원목록", "직원관리", "직원목록"); ?>
...
<!--                                --><?php //endif; ?>
                            ...
                            <table class="table">
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td class="min-width">
                                            <p>
                                                <a href="/admin/employee/edit.php?id=<?php echo $value['id'] ?>" title="<?php echo $value['identity'] ?>">
                                                    <?php
                ...
                <div class="col-lg-12">
                    <div class="d-flex justify-content-between">
                        ...
                        <div>
                            <a href="/admin/employee/create.php" class="btn primary-btn btn-hover">등록</a>
                        </div>

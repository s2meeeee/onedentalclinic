...
<section class="section">
    <div class="container-fluid">
        <?php echo sectionTitle("직원수정", "직원관리", "직원수정"); ?>
        <div class="col-lg-12">
            <div class="card-style settings-card-2 mb-30">
                <form id="_form" method="post">
                    ...
                    <div class="row">
                        ...
                        <div class="col-6">
                            <div class="select-style-1">
                                ...
                                <div class="select-position">
                                    <select name="gubun">
                                        <option value="worker" <?php if($data['gubun'] == "worker") echo 'selected' ?>>일반직원</option>
                                        <option value="a_worker" <?php if($data['gubun'] == "a_worker") echo 'selected' ?>>관리직원</option>
                                    </select>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-12 d-flex justify-content-between">
                        <a class="btn info-btn btn-hover" href="/admin/employee">목록</a>
                        <div>
                            <a href="/admin/employee/password.php?id=<?php echo $data['id'] ?>" class="btn btn-info btn-hover text-white me-3" >비밀번호 변경</a>

...
<section class="section">
    <div class="container-fluid">
        <?php echo sectionTitle("팝업목록", "팝업관리", "팝업목록"); ?>
...
<!--                                </form>-->
                                ...
                                if($data['total_cnt'] > 0):
                                    ...
                                    foreach($data['values'] as $value):
                                        ...
                                        <tr>
                                            ...
                                            <td class="min-width">
                                                <p>
                                                    <a href="/admin/popup/edit.php?id=<?php echo $value['id'] ?>" title="<?php echo $value['title'] ?>">
                                                        <?php echo $value['title']; ?>
                                                    </a>
                                                </p>
                                            </td>
                                            <td class="min-width">
                                                <p><?php echo $value['is_active'] == "Y" ? "노출" : "비노출" ?></p>
                                            </td>
                                            <td class="min-width">
                ...
                <div class="col-lg-12">
                    <div class="d-flex justify-content-between">
                        ...
                        <div>
                            <a href="/admin/popup/create.php" class="btn primary-btn btn-hover">등록</a>
                        </div>

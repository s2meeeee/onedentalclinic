...
<section class="section">
    <div class="container-fluid">
        <?php echo sectionTitle("치료전후사진 목록", "치료전후사진 관리", "치료전후사진 목록"); ?>
...
<!--                                </form>-->
                                ...
                                if($data['total_cnt'] > 0):
                                    ...
                                    foreach($data['values'] as $value):
                                        ...
                                        <tr>
                                            ...
                                            <td class="min-width">
                                                <p>
                                                    <a href="/admin/before-after/edit.php?id=<?php echo $value['id'] ?>" title="<?php echo $value['title'] ?>">
                                                        <?php
                                            ...
                                            <td class="min-width">
                                                <p><?php echo $value['therapy_location'] ?></p>
                                            </td>
                                            <td class="min-width">
                                                <p><?php echo $value['implant_number'] ?></p>
                                            </td>
                                            <td class="min-width">
                ...
                <div class="col-lg-12">
                    <div class="d-flex justify-content-between">
                        ...
                        <div>
                            <a href="/admin/before-after/create.php" class="btn primary-btn btn-hover">등록</a>
                        </div>
                    </div>
                </div>
            </div>

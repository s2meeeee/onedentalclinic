...
<section class="section">
    <div class="container-fluid">
        <?php echo sectionTitle("비급여 제증명수수료 등록", "비급여 제증명수수료 관리", "비급여 제증명수수료 등록"); ?>
        <div class="col-lg-12">
                ...
                <form id="_form" method="post" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 d-flex justify-content-between">
                            <a class="btn info-btn btn-hover" href="/admin/unpaid-proof">목록</a>
...
<script>
    jQuery("#_form").submit(function(event){
        ...
        if (checkValidate === true) {
            jQuery.ajax({
                type:"POST",
                url:"../../controller/unpaid_proof_proc.php",
                dataType:"json",
                ...
                success: function(response) {
                    if (response.result) {
                        alert(response.msg);
                        location.href = '/admin/unpaid-proof';
                    } else {
                        alert(response.msg);
                        return false;
                    }

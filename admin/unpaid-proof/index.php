...
$controller_proc = "unpaid_proof_proc.php";
$table = "unpaid_proofs";
$excel_title = "비급여 제증명수수료 ".date("Y-m-d h:i:s");
...
<section class="section">
    <div class="container-fluid">
        <?php echo sectionTitle("비급여 제증명수수료 목록", "비급여 제증명수수료 관리", "비급여 제증명수수료 목록"); ?>
            ...
            <div class="row">
                                ...
                                if($data['total_cnt'] > 0):
                                    ...
                                    foreach($data['values'] as $value):
                                        ...
                                        <tr>
                                            ...
                                            <td class="min-width">
                                                <p>
                                                    <a href="/admin/unpaid-proof/edit.php?id=<?php echo $value['id'] ?>" title="<?php echo $value['designation'] ?>">
                ...
                <div class="col-lg-12">
                    <div class="d-flex justify-content-between">
                        ...
                        <div>
                            <a href="/admin/unpaid-proof/create.php?order_number=<?php echo $order_number ?>" class="btn primary-btn btn-hover">등록</a>
                        </div>

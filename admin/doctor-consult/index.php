...
$controller_proc = "doctor_consult_proc.php";
$table = "doctor_consults";

$excel_title = "전문의 상담실  ".date("Y-m-d h:i:s");
...
<section class="section">
    <div class="container-fluid">
        <?php echo sectionTitle("전문의 상담실 목록", "전문의 상담실 관리", "전문의 상담실 목록"); ?>
                                ...
                                if($data['total_cnt'] > 0):
                                    ...
                                    foreach($data['values'] as $value):
                                        ...
                                        <tr>
                                            ...
                                            <td class="min-width">
                                                <p><?php echo $dao->board->getDoctorItem('doctors', $value['doctor_id'])['name'] ?></p>
                                            </td>
                                            <td class="min-width">
                                                <p>
                                                    <a href="/admin/doctor-consult/edit.php?id=<?php echo $value['id'] ?>" title="<?php echo $value['title'] ?>">
                                                        <?php
                                                        if(mb_strlen($value['title'], 'utf-8') > 36):
                                                            echo iconv_substr($value['title'], 0, 20, "utf-8").'...';
                                                        else:
                                                            echo $value['title'];
                                                        endif;
                                                        ?>
                                            ...
                                            <td class="min-width">
                                                <p><?php echo statusText($value['status']); ?></p>
                                            </td>
                                            <td class="min-width">
                                                <p><?php echo $value['open'] ?></p>
                                            </td>
                                            <td class="min-width">
                                                <p><?php echo $value['written_by'] ?></p>
                                            </td>
                                            <td class="min-width">
                                                <p><?php echo $dao->board->getCommentCount('doctor_consult_comments', 'doctor_consult_id', $value['id']) ?></p>
                                            </td>
                                            <td class="min-width">
                                                <div class="lead-text">

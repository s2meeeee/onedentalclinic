...
$excel_title = "진료일기 ".date("Y-m-d h:i:s");
...
<section class="section">
    <div class="container-fluid">
        <?php echo sectionTitle("진료일기 목록", "진료일기 관리", "진료일기 목록"); ?>
...
<!--                                </form>-->
                                ...
                                if($data['total_cnt'] > 0):
                                    ...
                                    foreach($data['values'] as $value):
                                        ...
                                        <tr>
                                            ...
                                            <td class="min-width">
                                                <p>
                                                    <a href="/admin/medical-diary/edit.php?id=<?php echo $value['id'] ?>" title="<?php echo $value['title'] ?>">
                                                        <?php
                ...
                <div class="col-lg-12">
                    <div class="d-flex justify-content-between">
                        ...
                        <div>
                            <a href="/admin/medical-diary/create.php" class="btn primary-btn btn-hover">등록</a>
                        </div>
                    </div>
                </div>
            </div>

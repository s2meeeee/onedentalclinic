<?php
    ...
    $data = $dao->getDetail("departments", $where);
...
<section class="section">
    <div class="container-fluid">
        <?php echo sectionTitle("부서관리 수정", "부서관리 관리", "부서관리 수정"); ?>
        <div class="col-lg-12">
                    ...
                    <div class="row">
                        <div class="col-6">
                            <div class="input-style-1">
                                ...
                                <input type="text" name="title" title="부서명" class="required"
                                       placeholder="부서명를 입력해주세요" value="<?php echo $data["title"] ?>">
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="select-style-1">
                                ...
                                <div class="select-position">
                                    <select name="show_yn" class="required">
                                        <option value="Y" <?php if($data['show_yn'] == "Y") echo 'selected' ?>>노출</option>
                                        <option value="N" <?php if($data['show_yn'] == "N") echo 'selected' ?>>비노출</option>
                                    </select>
                                </div>
                            </div>
                        </div>

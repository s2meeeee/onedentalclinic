<?php
    ...
    $backUrl = "/admin/unpaid-treatment";
    ...
    $data = $dao->getDetail("unpaid_treatments", $where);
...
<section class="section">
    <div class="container-fluid">
        <?php echo sectionTitle("비급여 치료재료대 수정", "비급여 치료재료대 관리", "비급여 치료재료대 수정"); ?>
        <div class="col-lg-12">
                    ...
                    <div class="row">
                        <div class="col-6">
                            <div class="input-style-1">
                                <label class="text-danger">분류</label>
                                <input type="text" name="middle_classification" title="분류" class="required"
                        ...
                        <div class="col-12 d-flex justify-content-between">
                            <a class="btn info-btn btn-hover" href="/admin/unpaid-treatment">목록</a>
...
<script>
    jQuery("#_form").submit(function(event){
        ...
        if (checkValidate === true) {
            jQuery.ajax({
                type:"POST",
                url:"../../controller/unpaid_treatment_proc.php",
                dataType:"json",

...
<section class="section">
    <div class="container-fluid">
        <?php echo sectionTitle("상단 배너 등록", "상단 배너 관리", "상단 배너 등록"); ?>
        <div class="col-lg-12">
            <div class="card-style settings-card-2 mb-30">
                <form id="_form" method="post" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        <div class="col-12">
                            <div class="input-style-1">
                                <label>PC (1920*953)</label>
                                <input type="file" name="file_01" title="PC">
                            </div>
                        </div>
                        <div class="col-12">
                            <div class="input-style-1">
                                <label>Mobile (720*1088)</label>
                                <input type="file" name="file_02" title=Mobile">
                            </div>
                        </div>
        ...
        if (checkValidate === true) {
            jQuery.ajax({
                ...
                success: function(response) {
                    if (response.result) {
                        alert(response.msg);
                        location.href = '/admin/top-banner';
                    } else {
                        alert(response.msg);
                        return false;
                    }

...
$controller_proc = "top_banner_proc.php";
$table = "top_banner";
...
<section class="section">
    <div class="container-fluid">
        <?php echo sectionTitle("상단 배너 목록", "상단 배너 관리", "상단 배너 목록"); ?>
                                ...
                                if($data['total_cnt'] > 0):
                                    ...
                                    foreach($data['values'] as $value):
                                        ...
                                        <tr>
                                            ...
                                            <td class="min-width">
                                                <p>
                                                    <a href="/admin/top-banner/edit.php?id=<?php echo $value['id'] ?>" title="<?php echo $value['title'] ?>">
                                                        <?php

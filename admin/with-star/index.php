...
$excel_title = "One&STARS ".date("Y-m-d h:i:s");
...
<section class="section">
    <div class="container-fluid">
        <?php echo sectionTitle("One&STARS 목록", "One&STARS 관리", "One&STARS 목록"); ?>
...
<!--                                </form>-->
                                ...
                                if($data['total_cnt'] > 0):
                                    ...
                                    foreach($data['values'] as $value):
                                        ...
                                        <tr>
                                            ...
                                            <td class="min-width">
                                                <p>
                                                    <a href="/admin/with-star/edit.php?id=<?php echo $value['id'] ?>" title="<?php echo $value['title'] ?>">
                                                        <?php
                ...
                <div class="col-lg-12">
                    <div class="d-flex justify-content-between">
                        ...
                        <div>
                            <a href="/admin/with-star/create.php" class="btn primary-btn btn-hover">등록</a>
                        </div>
                    </div>
                </div>
            </div>

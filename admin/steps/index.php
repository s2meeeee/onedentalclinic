...
<section class="section">
    <div class="container-fluid">
        <?php echo sectionTitle("스텝관리 목록", "스텝관리 관리", "스텝관리 목록"); ?>
...
<!--                                    <th><h6>노출순서</h6></th>-->
                                ...
                                if($data['total_cnt'] > 0):
                                    ...
                                    foreach($data['values'] as $value):
                                        ...
                                        <tr>
                                            ...
                                            <td class="min-width">
                                                <p>
                                                    <a href="/admin/steps/edit.php?id=<?php echo $value['id'] ?>" title="<?php echo $value['name'] ?>">
                                                        <?php echo $value['name']; ?>
                                                    </a>
                                                </p>
                                            </td>
                ...
                <div class="col-lg-12">
                    <div class="d-flex justify-content-between">
                        ...
                        <div>
                            <a href="/admin/steps/create.php" class="btn primary-btn btn-hover">등록</a>
                        </div>

...
include_once DAO_PATH.'/JobPosingDao.class.php';
...
$controller_proc = "job_posting_proc.php";
$table = "job_postings";
$excel_title = "채용정보 ".date("Y-m-d h:i:s");
...
<section class="section">
    <div class="container-fluid">
        <?php echo sectionTitle("채용정보 목록", "채용정보 관리", "채용정보 목록"); ?>
            ...
            <div class="row">
                                ...
                                if($data['total_cnt'] > 0):
                                    ...
                                    foreach($data['values'] as $value):
                                        ...
                                        <tr>
                                            ...
                                            <td class="min-width">
                                                <p>
                                                    <a href="/admin/job-posting/edit.php?id=<?php echo $value['id'] ?>" title="<?php echo $value['title'] ?>">
                                                        <?php
                ...
                <div class="col-lg-12">
                    <div class="d-flex justify-content-between">
                        ...
                        <div>
                            <a href="/admin/job-posting/create.php" class="btn primary-btn btn-hover">등록</a>
                        </div>

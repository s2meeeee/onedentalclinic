...
<section class="section">
    <div class="container-fluid">
        <?php echo sectionTitle("오늘 수술 전후 등록", "오늘 수술 전후 관리", "오늘 수술 전후 등록"); ?>
        <div class="col-lg-12">
            <div class="card-style settings-card-2 mb-30">
                <form id="_form" method="post" enctype="multipart/form-data">
                    <input type="hidden" name="mode" value="insert" readonly>
                    <input type="hidden" name="gubun" value="videoReview" readonly>
...
<!--                        </div>-->
                        <div class="col-12 d-flex justify-content-between">
                            <a class="btn info-btn btn-hover" href="/admin/video-review">목록</a>
        ...
        if (checkValidate === true) {
            jQuery.ajax({
                ...
                success: function(response) {
                    if (response.result) {
                        alert(response.msg);
                        location.href = '/admin/video-review';
                    } else {
                        alert(response.msg);
                        return false;
                    }

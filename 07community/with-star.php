    ...
    <div class="boardListImg boardListImg2">
        ...
        if($data['total_cnt'] > 0):
            ...
            foreach($data['values'] as $value):
                ?>
			<li onclick="location.href='with-star_view.php?id=<?= $value['id']; ?>';">
				<ol class="img01"><img style="width: 100%;" src="<?= $value['file_01_path']; ?>"  alt="<?= $value['title']; ?>"/></ol>
				<ol class="info">
					<dt>스타와 함께 #<?= $no--;?> <?= $value['title']; ?></dt>
            ...
            <li style="width: 100%; cursor: auto;">
                <div style="display: flex; justify-content: center; align-items: center; height: 8vh;">
                    <b style="font-size: 2.4rem;">스타와 함께가 없습니다.</b>
                </div>
            </li>
        <?php endif; ?>
		</ul>

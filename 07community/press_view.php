...
$prevNextData = $dao->board->getBoardPrevNext('notices', $_GET['id'], "press");
?>
...
<div id="wrapper">
    <div class="inner">
        ...
        <div class="boardBtn">
            <span class="right">
                <a href="press.php" class="list">목록</a>
            </span>
        </div>
        <!-- //버튼 -->
        ...
        <div class="boardBottomList">
            <ul>
                ...
                <li><span>이전</span><a
                        href="/07community/press_view.php?id=<?= $prevNextData[1]['id']; ?>"><?= $prevNextData[1]['title']; ?></a>
                </li>
                <?php endif; ?>
                <?php if($prevNextData[0]): ?>
                <li><span>다음</span><a
                        href="/07community/press_view.php?id=<?= $prevNextData[0]['id']; ?>"><?= $prevNextData[0]['title']; ?></a>
                </li>
                <?php endif; ?>
            </ul>
        </div>

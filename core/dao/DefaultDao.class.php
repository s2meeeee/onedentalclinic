<?php
	class DefaultDao
	{
        ...
        // 이전/다음 글 가져오기
        public function getBoardPrevNext($view_table,$id, $where = null)
        {
            $where .= "";
        ...
        public function getDoctors($view_table, $department)
        {
            $query = "select id, name from " . $view_table . " where department = '" . $department . "'";

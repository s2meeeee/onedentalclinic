<?php
	class UnpaidTreatmentDao
	{
        ...
        {
            if ($this->db->insert('unpaid_treatments',$params['unpaid_treatments'])) {
                $this->result = true;
        ...
        {
            if ($this->db->update('unpaid_treatments',$params['unpaid_treatments'], $where)) {
                $this->result = true;

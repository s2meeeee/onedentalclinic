<?php
	class InquiryConsultCommentDao
	{
		var $db;
        var $board;
        var $result = false;
        ...
        {
            if ($this->db->insert('doctor_consult_comments',$params['doctor_consult_comments'])) {
                $this->result = true;
        ...
        {
            if ($this->db->update('doctor_consult_comments',$params['doctor_consult_comments'], $where)) {
                $this->result = true;

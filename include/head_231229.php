	...
	<div id="wrap">
		...
		<div id="header" class="header">
			...
			<div class="headerTop web">
                ...
                <button type="button" id="gnb_open"  ><img src="https://nowwd.speedgabia.com/onedc/all.png"  alt=""/><span class="sound_only"> 메뉴열기</span></button>
                
            </div> 
			
			<div class="headerTopM mobile">
                 <div class="inner">
         			<a href="/" class="logoM"><img src="https://nowwd.speedgabia.com/onedc/logo2.png"  alt=""/></a>
       
                <button type="button" id="gnb_open" onclick = "document.all['gnb2'].style.display = 'inline';" ><img src="https://nowwd.speedgabia.com/onedc/all.png"  alt=""/><span class="sound_only"> 메뉴열기</span></button>
				</div>
            </div>    
		...
		<li><a href="<?php echo menu01_url ?>"><?php echo menu01 ?></a>
            ...
            <ul>
                <ol class="inner">
					...
					<article>
                        <!--a href="<?php echo menu0301_url ?>"><?php echo menu0301 ?></a-->
